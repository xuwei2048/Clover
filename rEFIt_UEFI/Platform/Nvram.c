...
CONST NVRAM_DATA ResetNvramData[] = {
  ...
  //{ L"IOHibernateRTCVariables",   &gAppleBootVariableGuid },
  //{ L"boot-image",                &gAppleBootVariableGuid },
  //{ L"boot-image-key",            &gAppleBootVariableGuid },
  //{ L"boot-signature",            &gAppleBootVariableGuid },
  //{ L"boot-switch-vars",          &gAppleBootVariableGuid },

  // Clover Variables
  { L"Clover.BackupDirOnDestVol", &gAppleBootVariableGuid },
  { L"Clover.KeepBackupLimit",    &gAppleBootVariableGuid },
  { L"Clover.LogEveryBoot",       &gAppleBootVariableGuid },
  { L"Clover.LogLineCount",       &gAppleBootVariableGuid },
  { L"Clover.MountEFI",           &gAppleBootVariableGuid },
  { L"Clover.NVRamDisk",          &gAppleBootVariableGuid },
  { L"Clover.Theme",              &gAppleBootVariableGuid },

  // Non-volatile Variables
  //{ L"backlight-level",           &gAppleBootVariableGuid },
  //{ L"bootercfg",                 &gAppleBootVariableGuid },
  { L"boot-args",                 &gAppleBootVariableGuid },
  //{ L"csr-active-config",         &gAppleBootVariableGuid },
  { L"install-product-url",       &gAppleBootVariableGuid },
  //{ L"platform-uuid",             &gAppleBootVariableGuid },
  { L"previous-system-uuid",      &gAppleBootVariableGuid },
  //{ L"prev-lang:kbd",             &gAppleBootVariableGuid },
  //{ L"security-mode",             &gAppleBootVariableGuid },
  { L"nvda_drv",                  &gAppleBootVariableGuid },
};
