...
PLATFORMDATA ApplePlatformData[] =
{
  ...
  //MacBook6,1
  { "MacBook6,1", "MB61.88Z.00CC.B00.1802021826", "Mac-F22C8AC8", // Intel Core 2 Duo P7550 @ 2.26 GHz
    "MacBook", "1.0", "451131JCGAY", "MacBook-White",
    { 0x01, 0x51, 0x0f, 0, 0, 0x53 },  "NA", "NA", 0x7a002 }, // need rBR RPlt ECPI
  //MacBook7,1
  { "MacBook7,1", "MB71.88Z.003F.B00.1802022149", "Mac-F22C89C8", // Intel Core 2 Duo P8600 @ 2.40 GHz
    "MacBook", "1.0", "451211MEF5X", "MacBook-White",
    { 0x01, 0x60, 0x0f, 0, 0, 0x06 },  "k87", "k87", 0x7a002 }, // need ECPI
  //MacBook8,1
  { "MacBook8,1", "MB81.88Z.0173.B00.1804091715", "Mac-BE0E8AC46FE800CC", // Intel Core M-5Y51 @ 1.20 GHz
    "MacBook", "1.0", "C02RCE58GCN3", "MacBook-Aluminum",
    { 0x02, 0x25, 0x0f, 0, 0, 0x87 },  "j92", "j92", 0xf0e007 },
  //MacBook9,1
  { "MacBook9,1", "MB91.88Z.0169.B00.1805021829", "Mac-9AE82516C7C6B903", // Intel Core m5-6Y54 @ 1.20 GHz
    "MacBook", "1.0", "C02RM408HDNK", "MacBook-Aluminum",
    { 0x02, 0x35, 0x0f, 0, 1, 0x05 },  "j93", "j93", 0xf0e007 }, // need ECPI
  //MacBook10,1
  { "MacBook10,1", "MB101.88Z.0161.B00.1804091553", "Mac-EE2EBD4B90B839A8", // Intel Core i5-7Y54 @ 1.30 GHz
  ...
  //MacBookPro6,1
  { "MacBookPro6,1", "MBP61.88Z.005D.B00.1804100943", "Mac-F22589C8", // Intel Core i5-540M @ 2.53 GHz
    "MacBook Pro", "1.0", "C02G5834DC79", "MacBook-Aluminum",
    { 0x01, 0x57, 0x0f, 0, 0, 0x18 },  "k17", "k17", 0x7a004 }, // need ECPI
  //MacBookPro6,2
  { "MacBookPro6,2", "MBP61.88Z.005D.B00.1804100943", "Mac-F22586C8", // Intel Core i7-620M @ 2.66 GHz
    "MacBook Pro", "1.0", "CK132A91AGW", "MacBook-Aluminum",
    { 0x01, 0x58, 0x0f, 0, 0, 0x17 },  "k74", "k74", 0x7a004 },
  //MacBookPro7,1
  { "MacBookPro7,1", "MBP71.88Z.003F.B00.1802021458", "Mac-F222BEC8", // Intel Core 2 Duo P8600 @ 2.40 GHz
    "MacBook Pro", "1.0", "CK145C7NATM", "MacBook-Aluminum",
    { 0x01, 0x62, 0x0f, 0, 0, 0x07 },  "branch", "k6", 0x7a004 }, // need ECPI
  //MacBookPro8,1
  { "MacBookPro8,1", "MBP81.88Z.0050.B00.1804101331", "Mac-94245B3640C91C81", // Intel Core i5-2415M @ 2.30 GHz
    "MacBook Pro", "1.0", "W89F9196DH2G", "MacBook-Aluminum",
    { 0x01, 0x68, 0x0f, 0, 0, 0x99 },  "k90i", "k90i", 0x7b005 },
  //MacBookPro8,2
  { "MacBookPro8,2", "MBP81.88Z.0050.B00.1804101331", "Mac-94245A3940C91C80", // Intel Core i7-2675QM @ 2.20 GHz
    "MacBook Pro", "1.0", "C02HL0FGDF8X", "MacBook-Aluminum",
    { 0x01, 0x69, 0x0f, 0, 0, 0x04 },  "trunk", "k91f", 0x7b005 }, // need ECPI
  //MacBookPro8,3
  { "MacBookPro8,3", "MBP81.88Z.0050.B00.1804101331", "Mac-942459F5819B171B", // Intel Core i7-2860QM @ 2.49 GHz
  ...
  //MacBookPro11,4
  { "MacBookPro11,4", "MBP114.88Z.0183.B00.1804091616", "Mac-06F11FD93F0323C5", // Intel Core i7-4770HQ @ 2.20 GHz
    "MacBook Pro", "1.0", "C02SNHACG8WN", "MacBook-Aluminum",
    { 0x02, 0x29, 0x0f, 0, 0, 0x23 },  "NA", "NA", 0xf0b007 }, // need rBR RPlt ECPI
  //MacBookPro11,5
  { "MacBookPro11,5", "MBP114.88Z.0183.B00.1804091616", "Mac-06F11F11946D27C5", // Intel Core i7-4870HQ @ 2.50 GHz
    "MacBook Pro", "1.0", "C02LSHACG85Y", "MacBook-Aluminum",
    { 0x02, 0x30, 0x0f, 0, 0, 0x02 },  "NA", "NA", 0xf0b007 }, // need rBR RPlt ECPI
  //MacBookPro12,1
  { "MacBookPro12,1", "MBP121.88Z.0176.B00.1804091715", "Mac-E43C1C25D4880AD6", // Intel Core i5-5257U @ 2.70 GHz
    "MacBook Pro", "1.0", "C02Q51OSH1DP", "MacBook-Aluminum",
    { 0x02, 0x28, 0x0f, 0, 0, 0x07 },  "j52", "j52", 0xf01008 },
  //MacBookPro13,1
  { "MacBookPro13,1", "MBP131.88Z.0220.B00.1804091552", "Mac-473D31EABEB93F9B", // Intel Core i5-6360U @ 2.00 GHz
    "MacBook Pro", "1.0", "C02SLHACGVC1", "MacBook-Aluminum",
    { 0x02, 0x36, 0x0f, 0, 0, 0x97 },  "2016mb", "j130", 0xf02009 }, // need ECPI
  //MacBookPro13,2
  { "MacBookPro13,2", "MBP132.88Z.0244.B00.1804091703", "Mac-66E35819EE2D0D05", // Intel Core i5-6287U @ 3.10 GHz
    "MacBook Pro", "1.0", "C02SLHACGYFH", "MacBook-Aluminum",
    { 0x02, 0x37, 0x0f, 0, 0, 0x20 },  "2016mb", "j79", 0xf02009 },
  //MacBookPro13,3
  { "MacBookPro13,3", "MBP133.88Z.0244.B00.1804091703", "Mac-A5C67F76ED83108C", // Intel Core i7-6920HQ @ 2.90 GHz
    "MacBook Pro", "1.0", "C02SLHACGTFN", "MacBook-Aluminum",
    { 0x02, 0x38, 0x0f, 0, 0, 0x07 },  "2016mb", "j80g", 0xf04009 },
  //MacBookPro14,1
  { "MacBookPro14,1", "MBP141.88Z.0175.B00.1804091553", "Mac-B4831CEBD52A0C4C", // Intel Core i5-7360U @ 2.30 GHz
    "MacBook Pro", "1.0", "C02TNHACHV29", "MacBook-Aluminum",
    { 0x02, 0x43, 0x0f, 0, 0, 0x06 },  "2017mbp", "j130a", 0xf0b009 },
  //MacBookPro14,2
  { "MacBookPro14,2", "MBP142.88Z.0175.B00.1804091703", "Mac-CAD6701F7CEA0921", // Intel Core i5-7267U @ 3.09 GHz
    "MacBook Pro", "1.0", "C02TQHACHV2N", "MacBook-Aluminum",
    { 0x02, 0x44, 0x0f, 0, 0, 0x01 },  "2017mbp", "j79a", 0xf09009 },
  //MacBookPro14,3
  { "MacBookPro14,3", "MBP143.88Z.0175.B00.1804091703", "Mac-551B86E5744E2388", // Intel Core i7-7700HQ @ 2.80 GHz
  ...
  //MacBookAir3,1
  { "MacBookAir3,1", "MBA31.88Z.0069.B00.1802022340", "Mac-942452F5819B1C1B", // Intel Core 2 Duo U9400 @ 1.40 GHz
    "MacBook Air", "1.0", "C02FLHACD0QX", "Air-Enclosure",
    { 0x01, 0x67, 0x0f, 0, 0, 0x10 },  "k16k99", "k99", 0x76005 },
  //MacBookAir3,2
  { "MacBookAir3,2", "MBA31.88Z.0069.B00.1802022340", "Mac-942C5DF58193131B", // Intel Core 2 Duo L9600 @ 2.13 GHz
    "MacBook Air", "1.0", "C02DRHACDDR3", "Air-Enclosure",
    { 0x01, 0x66, 0x0f, 0, 0, 0x61 },  "NA", "NA", 0x76005 }, // need rBR RPlt ECPI
  //MacBookAir4,1
  { "MacBookAir4,1", "MBA41.88Z.0080.B00.1804111222", "Mac-C08A6BB70A942AC2", // Intel Core i7-2677M @ 1.80 GHz
    "MacBook Air", "1.0", "C02KGHACDRV9", "Air-Enclosure",
    { 0x01, 0x74, 0x0f, 0, 0, 0x04 },  "k21k78", "k78", 0x76005 }, // need ECPI
  //MacBookAir4,2
  { "MacBookAir4,2", "MBA41.88Z.0080.B00.1804111222", "Mac-742912EFDBEE19B3", // Intel Core i5-2557M @ 1.70 GHz
  ...
  //MacBookAir7,1
  { "MacBookAir7,1", "MBA71.88Z.0177.B00.1804091616", "Mac-9F18E312C5C2BF0B", // Intel Core i5-5250U @ 1.60 GHz
    "MacBook Air", "1.0", "C02PCLGFH569", "Air-Enclosure",
    { 0x02, 0x26, 0x0f, 0, 0, 0x02 },  "j110", "j110", 0x7b007 },
  //MacBookAir7,2
  { "MacBookAir7,2", "MBA71.88Z.0177.B00.1804091616", "Mac-937CB26E2E02BB01", // Intel Core i7-5650U @ 2.20 GHz
  ...
  //Macmini4,1
  { "Macmini4,1", "MM41.88Z.0047.B00.1802021546", "Mac-F2208EC8", // Intel Core 2 Duo P8600 @ 2.40 GHz
    "Mac mini", "1.0", "C02FHBBEDD6H", "Mini-Aluminum",
    { 0x01, 0x65, 0x0f, 0, 0, 0x02 },  "NA", "NA", 0x78002 }, // need rBR RPlt ECPI
  //Macmini5,1
  { "Macmini5,1", "MM51.88Z.0080.B00.1804091930", "Mac-8ED6AF5B48C039E1", // Intel Core i5-2415M @ 2.30 GHz
    "Mac mini", "1.0", "C07GA041DJD0", "Mini-Aluminum",
    { 0x01, 0x30, 0x0f, 0, 0, 0x03 },  "NA", "NA", 0x7d005 }, // need rBR RPlt
  //Macmini5,2
  { "Macmini5,2", "MM51.88Z.0080.B00.1804091930", "Mac-4BC72D62AD45599E", // Intel Core i7-2620M @ 2.70 GHz
    "Mac mini", "1.0", "C07HVHACDJD1", "Mini-Aluminum",
    { 0x01, 0x75, 0x0f, 0, 0, 0x00 },  "NA", "NA", 0x7d005 }, // need rBR RPlt ECPI
  //Macmini5,3
  { "Macmini5,3", "MM51.88Z.0080.B00.1804091930", "Mac-7BA5B2794B2CDB12", // Intel Core i7-2635QM @ 2.00 GHz
  ...
  //Macmini7,1
  { "Macmini7,1", "MM71.88Z.0231.B00.1804091715", "Mac-35C5E08120C7EEAF", // Intel Core i5-4278U @ 2.60 GHz
  ...
  //iMac10,1
  { "iMac10,1", "IM101.88Z.00D0.B00.1802021905", "Mac-F2268CC8", // Intel Core 2 Duo E7600 @ 3.06 GHz
    "iMac", "1.0", "W80AA98A5PE", "iMac-Aluminum",
    { 0x01, 0x53, 0x0f, 0, 0, 0x13 },  "k22k23", "k23", 0x7b002 },
  //iMac11,1
  { "iMac11,1", "IM111.88Z.0039.B00.1804101044", "Mac-F2268DAE", // Intel Core i7-860 @ 2.80 GHz
    "iMac", "1.0", "G8942B1V5PJ", "iMac-Aluminum",
    { 0x01, 0x54, 0x0f, 0, 0, 0x36 },  "k23f", "k23f", 0x7b004 },
  //iMac11,2
  { "iMac11,2", "IM112.88Z.005D.B00.1804101436", "Mac-F2238AC8", // Intel Core i3-540 @ 3.06 GHz
    "iMac", "1.2", "W8034342DB7", "iMac-Aluminum",
    { 0x01, 0x64, 0x0f, 0, 0, 0x05 },  "k74", "k74", 0x7c004 },
  //iMac11,3
  { "iMac11,3", "IM112.88Z.005D.B00.1804101436", "Mac-F2238BAE", // Intel Core i5-760 @ 2.80 GHz
    "iMac", "1.0", "QP0312PBDNR", "iMac-Aluminum",
    { 0x01, 0x59, 0x0f, 0, 0, 0x02 },  "k74", "k74", 0x7d004 },
  //iMac12,1
  { "iMac12,1", "IM121.88Z.004F.B00.1804101150", "Mac-942B5BF58194151B", // Intel Core i7-2600S @ 2.80 GHz
    "iMac", "1.9", "W80CF65ADHJF", "iMac-Aluminum",
    { 0x01, 0x71, 0x0f, 0, 0, 0x22 },  "k60", "k60", 0x73005 },
  //iMac12,2
  { "iMac12,2", "IM121.88Z.004F.B00.1804101150", "Mac-942B59F58194171B", // Intel Core i5-2500S @ 2.70 GHz
  ...
  //iMac16,1
  { "iMac16,1", "IM161.88Z.0219.B00.1804091616", "Mac-A369DDC4E67F1C45", // Intel Core i5-5250U @ 1.60 GHz
  ...
  //iMac17,1
  { "iMac17,1", "IM171.88Z.0154.B00.1805021829", "Mac-B809C3757DA9BB8D", // Intel Core i7-6700K @ 4.00 GHz
  ...
  //iMac18,1
  { "iMac18,1", "IM181.88Z.0158.B00.1804091703", "Mac-4B682C642B45593E", // Intel Core i5-7360U @ 2.30 GHz
    "iMac", "1.0", "C02TDHACH7JY", "iMac-Aluminum",
    { 0x02, 0x39, 0x0f, 0, 0, 0x06 },  "j133_4_5", "NA", 0xf07009 }, // need RPlt ECPI
  //iMac18,2
  { "iMac18,2", "IM183.88Z.0158.B00.1804091704", "Mac-77F17D7DA9285301", // Intel Core i5-7500 @ 3.40 GHz
    "iMac", "1.0", "C02TDHACJ1G5", "iMac-Aluminum",
    { 0x02, 0x40, 0x0f, 0, 0, 0x00 },  "j133_4_5", "NA", 0xf07009 }, // need RPlt ECPI
  //iMac18,3
  { "iMac18,3", "IM183.88Z.0158.B00.1804091704", "Mac-BE088AF8C5EB4FA2", // Intel Core i7-7700K @ 4.20 GHz
  ...
  //MacPro5,1
  { "MacPro5,1", "MP51.88Z.0087.B00.1804181525", "Mac-F221BEC8", // Intel Xeon X5675 @ 3.06 GHz x2
